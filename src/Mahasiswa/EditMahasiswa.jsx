    ...
    <div className="container mx-auto mt-8 p-4 bg-zinc-800 text-white rounded-lg shadow-lg max-w-md">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          ...
          <input id="nama" name="nama" type="text" className="w-full px-4 py-2 rounded-lg bg-zinc-700 text-white" value={formData.nama} onChange={handleChange} required />
        </div>
        <div className="mb-4">
          <label htmlFor="nim" className="block text-sm font-bold mb-2">
            NIM
          </label>
          <input id="nim" name="nim" type="text" className="w-full px-4 py-2 rounded-lg bg-zinc-700 text-white" value={formData.nim} onChange={handleChange} required />
        </div>
        <div className="mb-4">
          <label htmlFor="email" className="block text-sm font-bold mb-2">
            Email
          </label>
          <input id="email" name="email" type="email" className="w-full px-4 py-2 rounded-lg bg-zinc-700 text-white" value={formData.email} onChange={handleChange} required />
        </div>
        <div className="mb-4">
          <label htmlFor="prodi" className="block text-sm font-bold mb-2">
            Program Studi
          </label>
          <select id="prodi" name="prodi" value={formData.prodi} onChange={handleChange} className="w-full px-4 py-2 rounded-lg bg-zinc-700 text-white" required>
        ...
        <div className="mb-4">
          ...
          <textarea id="alamat" name="alamat" className="w-full px-4 py-2 rounded-lg bg-zinc-700 text-white" value={formData.alamat} onChange={handleChange} required></textarea>
        </div>
